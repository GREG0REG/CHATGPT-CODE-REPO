...
class SyllabusAddEditScreen extends StatefulWidget {
  final dynamic existing; // Could be SyllabusSubject, SyllabusUnit, etc.
  final int? parentSubjectId;
  final int? parentUnitId;
  final int? parentTopicId;
  final String level; // 'subject', 'unit', 'topic', 'subtopic'
...
class _SyllabusAddEditScreenState extends State<SyllabusAddEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.existing == null ? 'Add ${widget.level.capitalize()}' : 'Edit ${widget.level.capitalize()}'),
      ),
      body: Padding(
