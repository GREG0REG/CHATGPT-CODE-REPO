...
class _AddEditEventScreenState extends State<AddEditEventScreen> {
  ...
  Widget _buildNeetExamTypeDropdown() {
    const items = [
      DropdownMenuItem(value: NeetExamType.none, child: Text('Not specified')),
      DropdownMenuItem(value: NeetExamType.mockTest, child: Text('Mock Test')),
      DropdownMenuItem(value: NeetExamType.revisionSession, child: Text('Revision Session')),
      DropdownMenuItem(value: NeetExamType.finalPrep, child: Text('Final Prep')),
      DropdownMenuItem(value: NeetExamType.pyqPractice, child: Text('PYQ Practice')),
    ];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildRevisionRoundDropdown() {
    const items = [
      DropdownMenuItem(value: RevisionRound.round1, child: Text('Round 1: First Reading')),
      DropdownMenuItem(value: RevisionRound.round2, child: Text('Round 2: Revision')),
      DropdownMenuItem(value: RevisionRound.round3, child: Text('Round 3: Final Revision')),
      DropdownMenuItem(value: RevisionRound.mockTestPhase, child: Text('Mock Test Phase')),
    ];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Card(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildDurationRow('Short Session', '< 1 hour', Icons.timer_outlined, Colors.teal),
                const Divider(height: 16),
                _buildDurationRow('Medium Session', '1 – 3 hours', Icons.timelapse_outlined, Colors.indigo),
                const Divider(height: 16),
                _buildDurationRow('Long Session', '3+ hours', Icons.hourglass_bottom_outlined, Colors.deepPurple),
              ],
            ),
          ),
        ),
  ...
  Widget _buildDurationRow(String label, String duration, IconData icon, Color color) {
    return Row(
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(duration, style: TextStyle(fontSize: 12, color: Theme.of(context).colorScheme.outline)),
            ],
          ),
        ),
      ],
    ...
    return Column(
      ...
      children: [
        ...
        SegmentedButton<String>(
          ...
          onSelectionChanged: (selected) {
            // UI-only state, no DB dependency
          },
        ),
      ],
    );
