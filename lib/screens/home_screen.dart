...
/// Callbacks that the app lifecycle observer can invoke.
class HomeScreenLifecycleCallbacks {
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    super.initState();
    // Register lifecycle callbacks so main.dart can control us without
    // accessing this private class directly.
    HomeScreenLifecycleCallbacks.onPause = pauseRefresh;
    HomeScreenLifecycleCallbacks.onResume = resumeRefresh;
    _loadAll();
  ...
  @override
  void dispose() {
    HomeScreenLifecycleCallbacks.onPause = null;
    HomeScreenLifecycleCallbacks.onResume = null;
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return EventCard(
                        key: ValueKey('${event.id}_${event.dateMillis}'),
                        event: event,
